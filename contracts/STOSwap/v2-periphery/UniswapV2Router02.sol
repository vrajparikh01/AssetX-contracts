...
import "../v2-core/libraries/TransferHelper.sol";
...
contract UniswapV2Router02 {
    event AddLiquidity(string message, uint amount);
    ...
    // tokenA => tokenB => liquidityAdded
    mapping(address => mapping(address => bool)) public liquidityAdded;
    ...
    {
        // Ensure that liquidity has not already been added to the pair
        require(!liquidityAdded[tokenA][tokenB] && !liquidityAdded[tokenB][tokenA], "Liquidity already added for this pair");
        liquidityAdded[tokenA][tokenB] = true;
